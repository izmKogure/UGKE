...
<p>通信技術などインフラの発展により、WEB動画広告を中心に、ビジネスのシーンで動画が活用される機会が急激に増えております。(この部分に動画広告の伸び率グラフのイメージを入れることは可能でしょうか)クライアント様の課題を、動画という手法で解決するには動画クリエイターの感性・技術がかかせません。動画新時代を共に歩んで頂ける方を求めております。</p>
<table id="form">
	<tbody>
		<tr>
			<th>募集職種</th>
