...
[su_tabs]
  [su_tab title="シンプルプラン" class="tab-menu1"]<div class="tab1"></div>[/su_tab]
  [su_tab title="スタンダードプラン" class="tab-menu2"]<div class="tab2"></div>[/su_tab]
  [su_tab title="ディレクターズプラン" class="tab-menu3"]<div class="tab3"></div>[/su_tab]
[/su_tabs]
'); ?>
</div>
</section>
