...
<section id="seisakuflow">
	<div class="pricewrapper">
		...
		<div class="center"><a href="<?php bloginfo('template_directory');?>/images/scenario_board.pdf"><img src="<?php bloginfo('template_directory');?>/images/price_button_01.png" width="358" height="30" alt="シナリオボードをダウンロードする"></a></div>
		<hr>
